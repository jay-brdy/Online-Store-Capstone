...
app.use(cors({
  origin: ['http://localhost:5173', 'https://jays-fishing-market.netlify.app', 'https://online-access--jays-fishing-market.netlify.app'],
...
const init = async () => {
  ...
  const [moe, lucy, chau, jay, horseMackerel, carp, pufferfish, seabass, clownfish, salmon, catfish, goldfish, oceanSunfish, koi, mahimahi, tuna, hammerheadShark, blueMarlin, arowana ] = await Promise.all([
    ...
    createProduct({
      name: 'Horse Mackerel',
      description: 'The horse mackerel, is a common fish that can be found in the ocean. Like the sea bass, it can be caught at any given time, month, or season.',
      price: 2.00,
      size: 2,
      inventory: 100
    }),
    ...
    createProduct({
      name: 'Sea Bass',
      description: 'The sea bass is a common oceanic fish that appears all day and all year-round. Once the most common ocean fish, this title has now been claimed by the horse mackerel.',
      price: 8.00,
      size: 5,
      inventory: 100
    }),
    createProduct({
      name: 'Clownfish',
      description: 'You found Nemo! The clownfish is a distinctive orange ocean-dwelling fish with white stripes.',
      price: 12.00,
      size: 1,
      inventory: 100
    }),
